...
?>
<div class="col-md-12">
	<a href="<?php echo base_url('suplayer/download_template') ?>" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-download"></i> Download Template</a>
	<hr>
	<div class="panel panel-default card card-default">
		<div class="panel panel-heading card card-header">
			upload data suplayer
		</div>
